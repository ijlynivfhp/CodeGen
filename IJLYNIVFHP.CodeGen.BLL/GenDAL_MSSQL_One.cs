...
namespace IJLYNIVFHP.CodeGen.BLL
{
    public class GenDAL_MSSQL_One
    {
        ...
        public static string GenAllCode(string ns, string tabname, string classname, string connstr)
        {
            ...
            conn.Open();
            string sql = "";
            sql += "SELECT a.[name] as '字段名',c.[name] '类型',e.value as '字段说明',sm.text as '默认值',a.colstat as '是否自增' FROM syscolumns  a  ";
            ...
            DataRow[] datarows = dt.Select("是否自增 = '1'");
            if (datarows.Count()> 0)
            {
                identify = datarows[0]["字段名"].ToString();
            }
            ...
            sb.Append("    /// 作者:IJLYNIVFHP(QQ:380726211)\r\n");
            ...
            sb.Append("            strSql.Append(\" where "+ identify + "=@"+ identify + " \");\r\n");
            sb.Append("            Database db = DatabaseFactory.CreateDatabase();\r\n");
            sb.Append("            DbCommand dbCommand = db.GetSqlStringCommand(strSql.ToString());\r\n");
            ...
            sb.Append("        /// \r\n");
            sb.Append("        /// </summary>\r\n");
            sb.Append("        public bool Delete(int "+ identify + ")\r\n");
            sb.Append("        {\r\n");
            sb.Append("            StringBuilder strSql = new StringBuilder();\r\n");
            ...
            sb.Append("            Database db = DatabaseFactory.CreateDatabase();\r\n");
            sb.Append("            DbCommand dbCommand = db.GetSqlStringCommand(strSql.ToString());\r\n");
            sb.Append("            db.AddInParameter(dbCommand, \"" + identify + "\", DbType.Int32, " + identify + ");\r\n");
            sb.Append("            int rows = db.ExecuteNonQuery(dbCommand);\r\n");
            sb.Append("            if (rows > 0)\r\n");
            sb.Append("            {\r\n");
            sb.Append("                return true;\r\n");
            ...
            sb.Append("        /// \r\n");
            sb.Append("        /// </summary>\r\n");
            sb.Append("        public " + ns + ".Model." + classname + " GetModel(int " + identify + ")\r\n");
            sb.Append("        {\r\n");
            sb.Append("            StringBuilder strSql = new StringBuilder();\r\n");
